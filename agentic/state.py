...
# Unclassified types: "<descriptive_term>-unclassified" (e.g., "ssrf-unclassified", "xss-unclassified")
...
class AttackPathClassification(BaseModel):
    ...
    attack_path_type: str = Field(
        description="The classified attack path type: 'cve_exploit', 'brute_force_credential_guess', 'phishing_social_engineering', 'denial_of_service', 'sql_injection', or '<term>-unclassified'"
    )
