...
# Known types: "cve_exploit", "brute_force_credential_guess", "phishing_social_engineering", "denial_of_service", "sql_injection", "ssrf"
# Unclassified types: "<descriptive_term>-unclassified" (e.g., "xss-unclassified")
AttackPathType = str  # Validated by AttackPathClassification.attack_path_type validator

KNOWN_ATTACK_PATHS = {"cve_exploit", "brute_force_credential_guess", "phishing_social_engineering", "denial_of_service", "sql_injection", "ssrf"}
